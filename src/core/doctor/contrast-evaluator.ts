...
function resolveColorToChroma(value: unknown): { color: chroma.Color; alpha: number } | null {
...
function computeRatio(background: chroma.Color, foreground: chroma.Color): number {
