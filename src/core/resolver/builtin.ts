...
export async function loadBuiltinPalette(name: string): Promise<BuiltinPalette | null> {
  try {
...
export async function loadBuiltinDimension(name: string): Promise<BuiltinDimension | null> {
  try {
